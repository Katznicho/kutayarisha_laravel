...
<head>
    ...
    <title>Kutayarisha Landing Page</title>
...
<body>
    ...
    <section class="section main-banner" id="top" data-section="section1">
        <video autoplay muted loop id="bg-video">
            ...
            <iframe width="420" src="https://youtu.be/2j2LxybfAdM">
            </iframe>
        </video>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="caption">
                            <h6>Hello Women</h6>
                            <h2>Welcome to Kutayarisha</h2>
                            <p>Kutayarisha is a web based application that helps women through out there maternity
                                period
                            </p>
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="categories">
                        <h4>Our Services</h4>
                        <ul>
                            <li><a href="#">Weekly Reminders</a></li>
                            <li><a href="#">Doctor Appointments</a></li>
                            <li><a href="#">Meal Plans</a></li>
                            <li><a href="#">Home Nurses</a></li>
                            <li><a href="#">Emergency Pick Ups</a></li>
                        </ul>
                        <div class="main-button-red">
